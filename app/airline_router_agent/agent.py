...
from airline_dob_agent.agent import root_agent as dob_agent
from airline_flight_agent.agent import root_agent as flight_agent
...
root_agent = Agent(
    ...
    instruction=(
        ...
        "and route them to the most qualified sub-agent:\n"
        "- If they ask about baggage, refunds, or policies -> 'airline_faq_agent'.\n"
        "- If they need to change their birth date or personal info -> 'airline_dob_agent'.\n"
